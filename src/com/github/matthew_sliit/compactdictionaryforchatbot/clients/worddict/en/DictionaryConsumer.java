package com.github.matthew_sliit.compactdictionaryforchatbot.clients.worddict.en;
...
public class DictionaryConsumer implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
	     ...
	     System.out.println("Enter Locale: (EN|ES)");
	     try {
			value1 = input.readLine();
			if(value1.equalsIgnoreCase("EN")) {
				//wordDictionary = new EnglishDictionary();
				dictionaryLang = "EN";
			}else if(value1.equalsIgnoreCase("ES")) {
				//wordDictionary = new SpanihsDictionary();
				dictionaryLang = "ES";
			}else {
